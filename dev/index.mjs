...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getQuery as getQuery$1, getCookie, getRequestHeaders, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, getRouterParam, readBody, getResponseStatusText } from 'file://C:/portfolioJana/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://C:/portfolioJana/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://C:/portfolioJana/node_modules/devalue/index.js';
import destr, { destr as destr$1 } from 'file://C:/portfolioJana/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, withLeadingSlash, withoutTrailingSlash, isRelative, joinRelativeURL } from 'file://C:/portfolioJana/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file://C:/portfolioJana/node_modules/vue/server-renderer/index.mjs';
import { propsToString, renderSSRHead } from 'file://C:/portfolioJana/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://C:/portfolioJana/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file://C:/portfolioJana/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://C:/portfolioJana/node_modules/hookable/dist/index.mjs';
import { klona } from 'file://C:/portfolioJana/node_modules/klona/dist/index.mjs';
import { snakeCase, kebabCase, pascalCase, camelCase } from 'file://C:/portfolioJana/node_modules/scule/dist/index.mjs';
import defu, { defuFn, defu as defu$1 } from 'file://C:/portfolioJana/node_modules/defu/dist/defu.mjs';
import { hash } from 'file://C:/portfolioJana/node_modules/ohash/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://C:/portfolioJana/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/portfolioJana/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/portfolioJana/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file://C:/portfolioJana/node_modules/consola/dist/index.mjs';
import { getContext } from 'file://C:/portfolioJana/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file://C:/portfolioJana/node_modules/errx/dist/index.js';
import { isVNode, version, unref } from 'file://C:/portfolioJana/node_modules/vue/index.mjs';
import { extname, isAbsolute } from 'file://C:/portfolioJana/node_modules/pathe/dist/index.mjs';
import { unified } from 'file://C:/portfolioJana/node_modules/unified/index.js';
import { toString } from 'file://C:/portfolioJana/node_modules/mdast-util-to-string/index.js';
import { postprocess, preprocess } from 'file://C:/portfolioJana/node_modules/micromark/dev/index.js';
import { stringifyPosition } from 'file://C:/portfolioJana/node_modules/unist-util-stringify-position/index.js';
import { markdownLineEnding, markdownSpace } from 'file://C:/portfolioJana/node_modules/micromark-util-character/dev/index.js';
import { push, splice } from 'file://C:/portfolioJana/node_modules/micromark-util-chunked/dev/index.js';
import { resolveAll } from 'file://C:/portfolioJana/node_modules/micromark-util-resolve-all/index.js';
import { normalizeUri } from 'file://C:/portfolioJana/node_modules/micromark-util-sanitize-uri/dev/index.js';
import slugify from 'file://C:/portfolioJana/node_modules/slugify/slugify.js';
import remarkParse from 'file://C:/portfolioJana/node_modules/remark-parse/index.js';
import remark2rehype from 'file://C:/portfolioJana/node_modules/remark-rehype/index.js';
import remarkMDC, { parseFrontMatter } from 'file://C:/portfolioJana/node_modules/remark-mdc/dist/index.mjs';
import remarkEmoji from 'file://C:/portfolioJana/node_modules/remark-emoji/index.js';
import remarkGFM from 'file://C:/portfolioJana/node_modules/remark-gfm/index.js';
import rehypeExternalLinks from 'file://C:/portfolioJana/node_modules/rehype-external-links/index.js';
import rehypeSortAttributeValues from 'file://C:/portfolioJana/node_modules/rehype-sort-attribute-values/index.js';
import rehypeSortAttributes from 'file://C:/portfolioJana/node_modules/rehype-sort-attributes/index.js';
import rehypeRaw from 'file://C:/portfolioJana/node_modules/rehype-raw/index.js';
import { detab } from 'file://C:/portfolioJana/node_modules/detab/index.js';
import { toString as toString$1 } from 'file://C:/portfolioJana/node_modules/hast-util-to-string/index.js';
import Slugger from 'file://C:/portfolioJana/node_modules/github-slugger/index.js';
import MiniSearch from 'file://C:/portfolioJana/node_modules/minisearch/dist/es/index.js';
import { fileURLToPath } from 'node:url';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file://C:/portfolioJana/node_modules/ipx/dist/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file://C:/portfolioJana/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file://C:/portfolioJana/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"C:/portfolioJana/server/assets"}];
...
storage.mount('content:source:content', unstorage_47drivers_47fs({"name":"content:source:content","driver":"fs","base":"C:\\portfolioJana\\content","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache:content', unstorage_47drivers_47fs({"driver":"fs","base":"C:\\portfolioJana\\.nuxt\\content-cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\portfolioJana","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\portfolioJana\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\portfolioJana\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\portfolioJana\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:\\portfolioJana\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _4CcSAi2ScS = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script$1}<\/script>`);
  });
});

const rootDir = "C:/portfolioJana";
  ...
  parse: async (_id, content) => {
    ...
    if (typeof content === "string") {
      if (_id.endsWith("json5")) {
        parsed = (await import('file://C:/portfolioJana/node_modules/json5/lib/index.js').then((m) => m.default || m)).parse(content);
...
const _ukbP6EnSio = defineNitroPlugin(async (nitro) => {
...
const _fWkGYn0NyY = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
...
const _dn00jj = defineEventHandler(async (event) => {
...
const _kGgNT7 = defineEventHandler(async (event) => {
...
const _X6JJjT = defineEventHandler(async (event) => {
  const runtimeConfig = useRuntimeConfig();
...
const _OO9duA = defineEventHandler(async (event) => {
  const query = getContentQuery(event);
...
const _iJDWcR = lazyEventHandler(() => {
...
const _lazy_25Qbc7 = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_25Qbc7, lazy: true, middleware: false, method: undefined },
  { route: '/api/_content/query/:qid/**:params', handler: _dn00jj, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query/:qid', handler: _dn00jj, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query', handler: _dn00jj, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/cache.json', handler: _kGgNT7, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/search', handler: _X6JJjT, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid/**:params', handler: _OO9duA, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid', handler: _OO9duA, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation', handler: _OO9duA, lazy: false, middleware: false, method: "get" },
  { route: '/_ipx/**', handler: _iJDWcR, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_25Qbc7, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file://C:/portfolioJana/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://C:/portfolioJana/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
